...
const createComponent = (path, options) => {
	...
	if (options.extension) {
		console.log(chalk.black.bgGreen(`[${componentName}] Extension '.${options.extension}' used !`))
	}
...
const createHook = (path, options) => {
	...
	if (options.extension) {
		console.log(chalk.black.bgGreen(`[${hookName}] Extension '.${options.extension}' used !`))
	}
...
export { createHook, createComponent, loadOptionsInConfigFileIfExists }